...
<fieldset>
    ...
    <table class="table">
        ...
        <tr >
            <td>姓名:</td>
            <td><input type="text" value="<%=userCount.getName()!=null?userCount.getName():"未设置"%>" /></td>
        </tr >
        <tr >
            <td>性别:</td>
            <td><input type="text" value="<%=userCount.getSex()%>"/></td>
        </tr>
        <tr >
            <td>籍贯:</td>
            <td><input type="text" value="<%=userCount.getOrigin()!=null?userCount.getOrigin():"未设置"%>"/></td>
        </tr>
        <tr >
            <td>出生日期:</td>
            <td><input type="text" value="<%=userCount.getBirthDate()!=null?userCount.getBirthDate():"未设置"%>"/></td>
        </tr>
        <tr>
            <td>手机:</td>
            <td><input type="text" value="<%=userCount.getCellPhone()!=null?userCount.getCellPhone():"未设置"%>"/></td>
        </tr>
        <tr >
            <td>邮箱:</td>
            <td><input type="text" value="<%=userCount.getEmail()!=null?userCount.getEmail():"未设置"%>"/></td>
        </tr>
        <tr >
            <td>QQ:</td>
            <td><input type="text" value="<%=userCount.getEmail()!=null?userCount.getQqnumber():"未设置"%>"/></td>
        </tr>
        <tr>
            <td>最近一次登录:</td>
