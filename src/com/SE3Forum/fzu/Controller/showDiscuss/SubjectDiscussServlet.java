package com.SE3Forum.fzu.Controller.showDiscuss;
 ...
 */
@WebServlet(name = "SubjectDiscussServlet")
public class SubjectDiscussServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            // 获取学习板块的帖子
            List<Topic> topicList =  topicService.findTopicWithplatOption(platForumType.SubjectDiscussPlat);
        ...
        request.setAttribute("users",userCounts);
            request.getRequestDispatcher(request.getContextPath()+"/SubjectDiscuss/all.jsp").forward(request,response);
