 ...
 */
@WebServlet(name = "FreezoneServlet")
public class FreezoneServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            // 获取学习板块的帖子
            List<Topic> topicList =  topicService.findTopicWithplatOption(platForumType.FreeZonePlat);
        ...
        request.setAttribute("users",userCounts);
            request.getRequestDispatcher(request.getContextPath()+"/freezone/all.jsp").forward(request,response);
